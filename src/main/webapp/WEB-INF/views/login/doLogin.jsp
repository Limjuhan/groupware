...
<head>
    ...
    <style>
        body {
            ...
            url('/img/login.jpg') center center / cover no-repeat fixed;
            display: flex;
            align-items: center;
        ...
        .btn-login:hover {
            background-color: rgba(13, 110, 253, 0.35); /* hover 색상 조금 더 진하게 */
            border-color: #0a58ca;
            color: #ffffff; /* hover 시 글씨색 하얗게 */
        }
